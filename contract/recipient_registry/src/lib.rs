...
use soroban_sdk::{
    contract, contractimpl, contracttype, contracterror, panic_with_error, Address, Env, Symbol, Vec, String,
};
...
mod test {
    ...
    fn test_cap_exceeded_returns_error() {
        ...
        // Disburse 600 (exceeds 500 cap) -> Error::CapExceeded
        let result = client.try_mark_disbursed(&recipient, &600);
    ...
    fn test_only_admin_can_register() {
        ...
        // Non-admin attempts to register -> Error::Unauthorized
        let result = client.try_register_recipient(
            &non_admin,
            &recipient,
    ...
    fn test_duplicate_registration_rejected() {
        ...
        client.register_recipient(
            &admin,
            &recipient,
            &String::from_str(&env, "East"),
            &String::from_str(&env, "ID-03"),
        );

        // Duplicate registration -> Error::AlreadyRegistered
        let result = client.try_register_recipient(
            &admin,
            &recipient,
            &String::from_str(&env, "East"),
